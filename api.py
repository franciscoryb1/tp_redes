...
from tp_redes import buscar_libros_por_lenguaje, buscar_libros_por_author, buscar_libros_entre_anios, buscar_libros_menores_anio, buscar_libros_menores_pagina,buscar_libros_country, buscar_libros_por_title, buscar_libros_posterior_anio, buscar_libros_pages,buscar_libros_igual_anio, buscar_libros_mayores_page, buscar_libros_entre_pages
...
def consulta(author=None, title=None,  country=None, lenguage=None, anio=None,anio_desde = None, anio_hasta=None, condicion = None, page=None, page_desde=None,page_hasta=None):
    ...
    if lenguage != None:
        lista = buscar_libros_country(libros_json, lenguage)
    if anio != None:
        if condicion == None:
            return 'Debe ingresar una condicion.'
        if condicion == 'a':
    ...
    if page != None:
        if condicion == 'a':
            lista = buscar_libros_menores_pagina(libros_json, page)
        if condicion == 'p':
    ...
    if page_desde != None and page_hasta != None:
        lista = buscar_libros_entre_pages(libros_json, page_desde, page_hasta)
