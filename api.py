...
def query(lista):
    return borrar(libros_json, lista)
...
# def insertar_libro_manual(libros, author, title, year, page, language,  country, imageLink=None, link=None):
#     nuevo_libro = {
#         "author": author,
#         "title": title,
#         "year": year,
